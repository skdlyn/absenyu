...
<head>
    ...
    <title>Welcome Back!!! Aspiring Programmers</title>
    <!-- Favicon-->
...
<body>
    <!-- Navigation-->
    <nav class="navbar navbar-light bg-transparent static-top justify-content-between">
        <div class="container">
            <div class="1">
                <a class="navbar-brand" href="/"><strong>REKAYASA PERANGKAT LUNAK | SMEAS</strong> </a>
            </div>
    </nav>
    <!-- Masthead-->
        ...
        <div class="container-fluid p-0">
            <div class="row g-0">
                <div class="col-lg-6 order-lg-2 text-white showcase-img"
                    style="background-image: url('template/img/kelas2.jpeg')"></div>
