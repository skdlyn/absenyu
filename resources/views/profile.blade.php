 <!-- Link CSS -->
 <link
     href="{{ asset('https://cdnjs.cloudflare.com/ajax/libs/MaterialDesign-Webfont/3.6.95/css/materialdesignicons.css') }}"
     rel="stylesheet" type="text/css">
 <link href="{{ asset('https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css') }}" rel="stylesheet"
     type="text/css">
 <link href="{{ asset('template/css/profile.css') }}" rel="stylesheet" type="text/css">
 <!-- Link JS -->
 ...
 <div class="container">
     <div class="main-body">
         ...
         <!-- Breadcrumb -->
         <nav aria-label="breadcrumb" style="background-color: #6b5b95">
             <ol class="breadcrumb">
